...
default['acadience-monitoring']['query-exporter']['repo']                  = '438308380087.dkr.ecr.us-east-1.amazonaws.com/prom/query-exporter'
...
normal['nagios']['pagerduty']                                  = node['env_nagios']['pagerduty']
