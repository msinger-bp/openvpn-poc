locals {
  ...
  default_tg_health_check_threshold = "3"   ##  HEALTHY THRESHOLD AND UNHEALTHY THRESHOLD MUST BE THE SAME FOR TARGET GROUPS WITH THE TCP PROTOCOL
  default_tg_health_check_interval  = "10"  ##  INTERVAL FOR TCP HEALTH CHECKS CAN BE EITHER '10' OR '30'
