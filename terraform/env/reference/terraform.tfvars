...
env                         = "<ENV>" # I.E., "dev", "prod", ETC, ALPHANUM - NO HYPHENS OR UNDERSCORES

##  OTHER GLOBAL RESOURCE TAGS
owner                       = "<OWNER>" # AWS TAG TO IDENTIFY ENGINEER OR GROUP RESPONSIBLE FOR THIS ENV
...
chef_environment            = "<ENV>" ##  CHANGE THIS TO THE CHEF ENVIRONMENT YOU WISH TO USE FOR THIS ENV
