...
env                         = "acdev1" # I.E., "dev", "prod", ETC, ALPHANUM - NO HYPHENS OR UNDERSCORES
...
default_data_volume_size                  = "10"
default_data_volume_type                  = "gp2"
default_data_volume_iops                  = ""
default_log_volume_size                   = "10"
default_log_volume_type                   = "gp2"
default_log_volume_iops                   = ""
...
vpc-main_cidr_16            = "10.20" # FIRST TWO OCTETS OF THE MAIN VPC CIDR, MUST START WITH "10."
...
chef_environment            = "acdev1" ##  CHANGE THIS TO THE CHEF ENVIRONMENT YOU WISH TO USE FOR THIS ENV

##  PRIVATE CERTIFICATE AUTHORITY
##  DISABLED B/C IT IS TOO EXPENSIVE
#root_acm_pca_arn           = "arn:aws:acm-pca:us-west-2:509819115418:certificate-authority/c077558d-86f0-4aea-a0a6-d4dd50bcfca3"
