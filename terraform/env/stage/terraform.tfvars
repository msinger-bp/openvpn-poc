...
env                         = "stage" # I.E., "dev", "prod", ETC, ALPHANUM - NO HYPHENS OR UNDERSCORES

##  OTHER GLOBAL RESOURCE TAGS
owner                       = "dlieberman" # AWS TAG TO IDENTIFY ENGINEER OR GROUP RESPONSIBLE FOR THIS ENV
billing_code                = "acadience-stage" # AWS TAG FOR BILLING ANALYSIS PURPOSES
...
chef_environment            = "stage" ##  CHANGE THIS TO THE CHEF ENVIRONMENT YOU WISH TO USE FOR THIS ENV
